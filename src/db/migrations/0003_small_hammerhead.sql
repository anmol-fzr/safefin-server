...
ALTER TABLE "quiz_to_category" RENAME TO "quiz_question_result";--> statement-breakpoint
ALTER TABLE "quiz_question_result" DROP CONSTRAINT "quiz_to_category_quiz_id_quiz_id_fk";
--> statement-breakpoint
ALTER TABLE "quiz_question_result" DROP CONSTRAINT "quiz_to_category_user_id_user_id_fk";
--> statement-breakpoint
ALTER TABLE "quiz_question_result" ADD COLUMN "question_id" integer NOT NULL;--> statement-breakpoint
ALTER TABLE "quiz_question_result" ADD COLUMN "answered_id" integer NOT NULL;--> statement-breakpoint
ALTER TABLE "quiz_question_result" ADD COLUMN "user_quiz_result_id" integer NOT NULL;--> statement-breakpoint
...
ALTER TABLE "user_quiz_result" ADD CONSTRAINT "user_quiz_result_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "quiz_question_result" DROP COLUMN "quiz_id";--> statement-breakpoint
ALTER TABLE "quiz_question_result" DROP COLUMN "user_id";